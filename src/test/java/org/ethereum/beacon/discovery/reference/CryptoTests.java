...
public class CryptoTests {
  ...
  private final NodeKeyService nodeKeyService = InMemoryNodeKeyService.create(LOCAL_SECRET);
  ...
  void testChallengeSign() {
    ...
    Bytes signatureBytes =
        HandshakeAuthData.signId(
            challengeDataBytes, ephemeralPubkeyBytes, nodeIdBBytes, nodeKeyService);
