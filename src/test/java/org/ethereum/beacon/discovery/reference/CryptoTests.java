...
public class CryptoTests {
  ...
  private final SecretKeyHolder secretKeyHolder = InMemorySecretKeyHolder.create(LOCAL_SECRET);
  ...
  void testChallengeSign() {
    ...
    Bytes signatureBytes =
        HandshakeAuthData.signId(
            challengeDataBytes, ephemeralPubkeyBytes, nodeIdBBytes, secretKeyHolder);
