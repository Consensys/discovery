...
public class Field<T> {
  ...
  public static final Field<SessionLookup> SESSION_LOOKUP = new Field<>(); // Node id, requests session lookup
  ...
  public static final Field<HandshakeMessagePacket> PACKET_HANDSHAKE = new Field<>(); // Auth header message packet
  public static final Field<MessagePacket<?>> PACKET_MESSAGE = new Field<>(); // Standard message packet
  public static final Field<OrdinaryMessagePacket> UNAUTHORIZED_PACKET_MESSAGE = new Field<>(); // Standard message packet
  public static final Field<V5Message> MESSAGE = new Field<>(); // Message extracted from the packet
  public static final Field<Bytes16> MASKING_IV = new Field<>(); // need to keep RawPacket IV for decrypting a message
  public static final Field<InetSocketAddress> REMOTE_SENDER = new Field<>(); // InetSocketAddress of remote sender
  ...
  public static final Field<Throwable> BAD_EXCEPTION = new Field<>(); // Stores exception for bad packet or message
}
