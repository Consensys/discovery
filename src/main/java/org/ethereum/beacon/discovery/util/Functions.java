...
public class Functions {
  ...
  public static HKDFKeys hkdfExpand(
      ...
      final Bytes destPubKey,
      final Bytes idNonce) {
    final Bytes keyAgreement = secretKeyHolder.deriveECDHKeyAgreement(destPubKey);
    return hkdfExpand(srcNodeId, destNodeId, keyAgreement, idNonce);
  }

  /**
   * {@link #hkdfExpand(Bytes, Bytes, SecretKeyHolder, Bytes, Bytes)} but with keyAgreement already
